...
# 🎮 Mexican Ninja — Community Edition

**Standalone Community Edition of the 2D action platformer, ready to play.**
...
Mexican Ninja is a 2D action platformer set in a vibrant Mexican-inspired world, where players battle through hand-crafted levels using fast-paced ninja combat. This Community Edition is a standalone build that runs fully offline with no storefront required. The package is self-contained and includes all content, ready to play immediately after extraction.

This build is for players who want a simple offline installation of Mexican Ninja on Windows PCs without any storefront dependencies.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3764970/9866516dd16e0508772d86aaf2c4531ae85e6484/ss_9866516dd16e0508772d86aaf2c4531ae85e6484.1920x1080.jpg?t=1787268632" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3764970/7baf02a9bf0f484943ed49f3029a9a043ff36a07/ss_7baf02a9bf0f484943ed49f3029a9a043ff36a07.1920x1080.jpg?t=1787268632" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3764970/630beb1dce6e431096168aed5fd41b89633b0f21/ss_630beb1dce6e431096168aed5fd41b89633b0f21.1920x1080.jpg?t=1787268632" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🥷 **Ninja Combat** — Fast melee combat with combo-based attacks and agile movement.
- 🌮 **Mexican-Inspired World** — Colorful levels, enemies, and visuals themed around Mexican culture.
- 🕹️ **2D Side-Scrolling Action** — Classic platformer structure with hand-crafted stages and challenges.
- 🎮 **Controller Support** — Playable with keyboard or gamepad.
- 💾 **Small Footprint** — Lightweight installation suitable for older hardware.
- 🔌 **Fully Offline** — No internet connection or additional software required to play.
- 📦 **Self-Contained Package** — All game files included in a single independent release.
...
| **Processor** | Intel Core 2 Duo 2.0 GHz or AMD equivalent | Intel Core i3 2.5 GHz or better |
| **RAM** | 2 GB | 4 GB |
| **Graphics** | DirectX 9.0c compatible video card | DirectX 11 compatible with 1 GB VRAM |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\MexicanNinja\Saved`
